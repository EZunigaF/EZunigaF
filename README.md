...
# Esteban Zúñiga · Forward Deployed Engineer

**Building production-ready software — end to end, every layer, every flow.**
...
I'm a software engineer with a background in AI engineering, transitioning into **Forward Deployed Engineering** — where technical depth meets real-world customer deployment.

I specialize in taking a product from concept to production: architecture, business logic, data layer, integrations, and deployment. Every stage, every flow, unified into one working product ready to ship.

- Currently deepening expertise in **AI-assisted software delivery**
- Focused on building systems that are **complete, not prototypes**
- Based in **Costa Rica** 🇨🇷
...
<div align="center">
<sub>Forward Deployed Engineer · AI Engineer · C# · .NET · Python · SQL · Costa Rica</sub>
</div>
